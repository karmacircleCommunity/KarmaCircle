...
[src/features/donate-shop-trending/pages/Donate.jsx](../../src/features/donate-shop-trending/pages/Donate.jsx) exists but **has no entry in `routesConfig.jsx`** — it cannot be reached by navigating the live app.
...
[src/features/donate-shop-trending/pages/Shop.jsx](../../src/features/donate-shop-trending/pages/Shop.jsx) (routed `/shop`) and [src/features/donate-shop-trending/pages/Trending.jsx](../../src/features/donate-shop-trending/pages/Trending.jsx) (routed `/trending`) are both thin wrappers around the shared `<ComingSoon />` component — see [src/components/comingSoon/ComingSoon.jsx](../../src/components/comingSoon/ComingSoon.jsx).
